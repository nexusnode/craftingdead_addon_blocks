...
public class PoleBarrierBlock extends OrientableBlockBase {
    ...
    public PoleBarrierBlock() {
        ...
        runCalculation(Stream.of(
                Block.makeCuboidShape(1, 0, 7, 3, 13, 9),
                Block.makeCuboidShape(13, 0, 7, 15, 13, 9),
                Block.makeCuboidShape(0, 9.3, 6, 16, 12.3, 7),
                Block.makeCuboidShape(0, 5.3, 6, 16, 8.3, 7),
                Block.makeCuboidShape(1, 13, 7, 3, 15.5, 9),
                Block.makeCuboidShape(13, 13, 7, 15, 15.5, 9)
