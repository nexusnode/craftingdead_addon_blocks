...
public class StopSignBlock extends OrientableBlockBase {
  ...
  public StopSignBlock() {
    ...
    runCalculation(Stream.of(Block.box(7, -16, 7, 9, -10, 9),
        Block.box(7.5, -10, 7.5, 8.5, 31, 8.5), Block.box(0, 20.68629, 7.25, 16, 27.31371, 7.5),
        Block.box(0, 20.68629, 7.2, 16, 27.31371, 7.55),
        Block.box(4.68629, 16, 7.26, 11.31371, 32, 7.51),
        Block.box(4.68629, 16, 7.27, 11.31371, 32, 7.52)).reduce((v1, v2) -> {
